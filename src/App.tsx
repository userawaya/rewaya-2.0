  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        src="/can.png"
        className="hidden rotate-3 h-[25vh] w-[40%] top-[95vh] sm:h-[23vh] sm:block absolute bottom-0 sm:w-[6%]  sm:top-[45vh] left-[27px] mb-4 ml-4 sm:ml-12"
      />
        ...
        src="/bag.png"
        className="hidden h-[25vh] w-[40%] top-[95vh] sm:h-[23vh] sm:block absolute bottom-0 sm:w-[9%]  sm:top-[56vh] left-[100px] mb-4 ml-4 sm:ml-12"
      />
        ...
        src="/small-can.png"
        className="hidden h-[25vh] w-[40%] top-[95vh] sm:h-[11vh] sm:block absolute bottom-0 sm:w-[8%]  sm:top-[67vh] left-0 mb-4 ml-4 sm:ml-12"
      />
        <motion.img
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.6 }}
        src="/group-25.png"
        className="hidden h-[25vh] rotate-12 sm:rotate-0 w-[40%] left-0 top-[85vh] sm:h-[20vh] sm:block absolute bottom-0 sm:w-[13%]  sm:top-[80vh] sm:left-8 mb-4 ml-4 sm:ml-12"
      />
      </motion.div>
      ...
      <motion.img
        ...
        transition={{ delay: 1.2 }}
        src="/sanitizer.png"
        className="hidden h-[25vh] w-[40%] top-[95vh] sm:h-[12vh] sm:block absolute bottom-0 sm:w-[5%]  sm:top-[58vh] right-[80px] mb-4 ml-4 sm:ml-12"
      />
        ...
        transition={{ delay: 1.0 }}
        src="/big-can.png"
        className="hidden h-[25vh] w-[40%] top-[95vh] sm:h-[17vh] sm:block absolute bottom-0 sm:w-[7%]  sm:top-[64vh] right-[130px] mb-4 ml-4 sm:ml-12"
      />
        ...
        transition={{ delay: 0.8 }}
        src="/little.png"
        className="hidden h-[25vh] w-[40%] top-[95vh] sm:h-[11vh] sm:block absolute bottom-0 sm:w-[8%]  sm:top-[67vh] right-[30px] mb-4 ml-4 sm:ml-12"
      />
        <motion.img
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
