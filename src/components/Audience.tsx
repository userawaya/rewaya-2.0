...
const Audience = () => {
  return (
    <div className='w-[100%] h-full bg-gradient-to-b from-[#344E10] via-[#79B426] to-[#79B426] flex flex-col justify-center items-center px-4 py-16'>
      ...
      <div className='bg-white w-[90%] sm:w-[70%] h-[70vh] rounded-2xl mt-10 flex justify-center items-center'>
      ...
      <div className='hidden sm:flex bg-white w-[70%] h-[70vh] rounded-2xl mt-10 justify-center items-center'>
        <div className='flex justify-between w-[85%] items-center'>
          <div className='flex flex-col w-[45%]'>
            ...
            <button className="bg-black hover:bg-gray-800 text-white px-3 py-3 w-[45%] rounded-lg font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 group">
              <span className="bg-[#79B426] text-gray-900 px-3 py-[13px] rounded mr-2">
                <div className='flex flex-row m-auto justify-end items-center'>
      ...
      <div className='sm:hidden bg-white w-[90%] h-[70vh] rounded-2xl mt-10 flex justify-center items-center'>
